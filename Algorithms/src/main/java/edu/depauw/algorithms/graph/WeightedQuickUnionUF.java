 ...
 * the classic <em>union</em> and <em>find</em> operations, along with a
 * <em>count</em> operation that returns the total number of sets.
 * <p>
 ...
 * <p>
 * This implementation uses <em>weighted quick union by size</em> (without path
 * compression). The constructor takes &Theta;(<em>n</em>), where <em>n</em> is
 * the number of elements. The <em>union</em> and <em>find</em> operations take
 * &Theta;(log <em>n</em>) time in the worst case. The <em>count</em> operation
 * takes &Theta;(1) time.
 * <p>
 * For alternative implementations of the same API, see {@link UF},
 * {@link QuickFindUF}, and {@link QuickUnionUF}. For additional documentation,
