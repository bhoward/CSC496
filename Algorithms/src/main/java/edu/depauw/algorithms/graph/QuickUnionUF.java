 ...
 * <p>
 * This implementation uses <em>quick union</em>. The constructor takes
 * &Theta;(<em>n</em>) time, where <em>n</em> is the number of sites. The
 * <em>union</em> and <em>find</em> operations take &Theta;(<em>n</em>) time in
 * the worst case. The <em>count</em> operation takes &Theta;(1) time.
 * <p>
